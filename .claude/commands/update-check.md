...
See `.claude/commands/references/update-check-guide.md` § Plugin scanning.
...
See `.claude/commands/references/update-check-guide.md` § Upstream check and § Quick summary format.
...
See `.claude/commands/references/update-check-guide.md` § Detailed view per plugin.
...
See `.claude/commands/references/update-check-guide.md` § Apply update flow.
