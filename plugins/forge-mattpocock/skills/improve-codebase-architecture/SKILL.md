...
**Use the project's glossary vocabulary for the domain, and [LANGUAGE.md](LANGUAGE.md) vocabulary for the architecture.** If the glossary defines "Order," talk about "the Order intake module" — not "the FooBarHandler," and not "the Order service." If a term you need is not in the glossary, that's a finding for the grilling step (see [GLOSSARY-FORMAT.md](../grill-with-docs/GLOSSARY-FORMAT.md) for how to capture it).
...
- **Naming a deepened module after a concept not in the glossary?** Add the term to `docs/glossary.md` (or wherever the project keeps its glossary) — same discipline as `grill-with-docs` (see [GLOSSARY-FORMAT.md](../grill-with-docs/GLOSSARY-FORMAT.md)). Create the file lazily if it doesn't exist.
