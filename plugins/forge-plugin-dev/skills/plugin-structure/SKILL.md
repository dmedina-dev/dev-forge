...
version: 0.1.0
---
<!-- Curated from anthropics/claude-code/plugins/plugin-dev/skills/plugin-structure · Anthropic Commercial Terms. Adapted: tracked in customizations.json (custom-05). -->
